document.addEventListener("DOMContentLoaded", function() {
    ...
    startBtn.addEventListener('click', async function() {
        ...
        try {
            const data = await BaseApi.api('/start_enhanced_conversation', {
                method: 'POST',
                headers: {
    ...
    stopBtn.addEventListener('click', async function() {
        ...
        try {
            const data = await BaseApi.api('/stop_enhanced_conversation', {
                method: 'POST'
            });
    ...
    clearBtn.addEventListener('click', async function() {
        ...
        try {
            const data = await BaseApi.api('/clear_history', {
                method: 'POST'
            });
    ...
    downloadButton.addEventListener('click', async function() {
        try {
            const blob = await BaseApi.api('/download_enhanced_history');
    ...
    async function fetchDefaultSettings() {
        try {
            const data = await BaseApi.api('/enhanced_defaults');
    ...
    characterSelect.addEventListener('change', async function() {
        ...
        try {
            const data = await BaseApi.api('/set_character', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (selectedCharacter.startsWith('story_') || selectedCharacter.startsWith('game_')) {
                ...
                try {
                    const historyData = await BaseApi.api('/get_character_history');
