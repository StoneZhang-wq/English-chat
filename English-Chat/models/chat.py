...
from sqlalchemy import Integer, Index, String, Enum, DateTime, ForeignKey, Text, Boolean,  Enum as SQLEnum
from sqlalchemy.orm import Mapped, mapped_column, relationship
from .base import Base, generate_uuid, SceneType
...
class ChatMessage(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_chat_message_char', 'character'),
    )
...
class ChatSession(Base):
    ...
    user_id: Mapped[int] = mapped_column(
        Integer,
        ForeignKey("users.id", ondelete="CASCADE"),  # 会话删除时消息也删除
        nullable=False,
        comment="所属用户ID"
    )
